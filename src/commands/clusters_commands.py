...
@click.option('--docket-number', default=None,
              help='Filter by docket number (docket__docket_number)')
@click.option('--court', default=None, help='Filter by court ID via join (docket__court)')
@click.option('--date-filed-after', default=None, help='Filed on or after ISO-8601 date')
@click.option('--date-filed-before', default=None, help='Filed on or before ISO-8601 date')
...
def list_clusters(limit, max_pages, docket, docket_number, court,
                  date_filed_after, date_filed_before, order_by,
